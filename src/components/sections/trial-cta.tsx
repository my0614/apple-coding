    ...
    <section className="bg-background">
      <div className="mx-auto max-w-6xl px-6 py-16 lg:py-20">
        <div className="flex flex-col items-start justify-between gap-6 rounded-[20px] bg-ink p-8 lg:flex-row lg:items-center lg:p-10">
          <div>
            <h2 className="text-2xl font-black text-balance text-paper lg:text-3xl">
              직접 수업을 들어보고 결정하세요
            </h2>
          ...
          <Link
            href="/#contact"
            className="shrink-0 rounded-xl bg-brand px-6 py-3.5 text-sm font-bold text-primary-foreground transition-colors hover:bg-brand-hover"
          >
            무료 체험 신청하기 →
          </Link>
        </div>
